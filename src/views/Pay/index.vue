  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a src="javascript:;" class="btn" to="/paysuccess" @click="open"
            >立即支付</a
          >
        </div>
        <div class="otherpay">
    ...
    async open() {
      ...
      try {
        const imgUrl = await QRCode.toDataURL(
          "https://github.com/GuYun-D?tab=repositories"
        );
        // 成功生成二维码才弹框
        this.$alert(`<img src="${imgUrl}" alt="">`, "请使用微信支付", {
